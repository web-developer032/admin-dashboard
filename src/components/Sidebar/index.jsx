...
const Sidebar = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={cn(
        `absolute left-0 top-0 z-9999 flex min-h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0`,
        sidebarOpen ? "translate-x-0" : "-translate-x-full",
      )}
    >
      {/* <!-- SIDEBAR HEADER --> */}
      <div className="flex justify-between items-center gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
